...
export const HeroSection = () => (
	<section className='relative w-full overflow-hidden bg-[#d4d4d4] bg-cover bg-hero-bg bg-[position:bottom_center] pt-[185px] md:pb-[130px] xl:pb-[170px]'>
		<Header />
		<div className='relative w-full mx-auto px-2 sm:px-5 min-w-[320px] max-w-[420px] md:max-w-[860px] xl:max-w-[1120px]'>
			<div>
			...
			<div className='absolute right-0 bg-cover bg-hero-woman bg-[position:center_right] w-0 md:w-[312px] xl:w-[348px] h-0 md:h-[377px] xl:h-[421px] md:bottom-[-175px] xl:bottom-[-220px]'></div>
		</div>
	</section>
);
