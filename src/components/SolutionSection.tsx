...
export const SolutionSection = () => (
	<section className='relative block overflow-hidden py-[25px] px-2 sm:px-5 border-y border-[#cacaca] md:py-10 md:px-[25px] xl:px-0 xl:pt-[60px] xl:pb-[50px]'>
		<div className='hidden sm:block absolute bg-no-repeat w-full h-[74px] top-0 -mt-[37px] bg-[url(/clip.png),url(/clip.png)] bg-auto bg-[position:left_110px_center,right_110px_center]'></div>
		<div className='w-full mx-auto min-w-[300px] max-w-[420px] md:max-w-[860px] xl:max-w-[1120px] px-[10px] md:px-5'>
